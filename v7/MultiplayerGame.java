...
public class MultiplayerGame implements Receiver
{
    ...
    public void receive(Message msg)
    {
        try
        {
            ...
            System.out.println("Bad reception");
        }
    }
    ...
    public void main(Player player1, Player player2, Player thisPlayer, Address opponent) throws InterruptedException
    {
        ...
        if (player1 == thisPlayer)
        {
            ...
            try
            {
                Network.gameChannel.send(new ObjectMessage(opponent, "Hi"));
            }
            catch (Exception e) {
                System.out.println("I told you not to kill the messenger!");
            }
        }
        else
        {
            try
            {
                Network.gameChannel.send(new ObjectMessage(opponent, "I'm the problem"));
            }
            catch (Exception e) {
