...
public class Network implements Receiver
{
    ...
    {
        long startTime = System.nanoTime(); //Benchmark time connecting to cluster. This depends on the computer and the network. This is really slow at school.
