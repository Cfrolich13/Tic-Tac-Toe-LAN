...
public class Network implements Receiver
{
    ...
    private void connectToGame(String gameCluster, Address sender, Address reciever, boolean isSender) throws Exception
    {
        channel.disconnect();
        ...
        new MultiplayerGame().main(player1, player2, thisPlayer, opponent);
    }
    ...
    private void acceptGame()
    {
        ...
        {
            channel.send(msg);
            System.out.println("Invite accepted. Connecting to " + newCluster + "...");
            connectToGame(newCluster, channel.getAddress(), opponent, true);
        }
        catch(Exception e) {
        }
    }
